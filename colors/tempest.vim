" Name: Tempest
" Description: Based on tempus_totus, a light theme for prose or for coding in an open space (WCAG AAA compliant)
...
let g:colors_name = "tempest"

" General
" -------
if exists("g:tempest_enforce_background_color")
