...
hi! Conceal ctermfg=0 ctermbg=NONE guifg=#000000 guibg=#ffffff 
...
hi! EndOfBuffer ctermfg=0 ctermbg=NONE guifg=#000000 guibg=#ffffff
...
hi! FoldColumn ctermfg=0 ctermbg=NONE guibg=#000000 guibg=#ffffff
hi! SignColumn ctermfg=0 ctermbg=NONE guifg=#000000 guibg=#ffffff
hi! IncSearch cterm=reverse gui=reverse
hi! LineNr ctermfg=0 ctermbg=NONE cterm=NONE gui=NONE guifg=#000000 guibg=#ffffff
hi! link LineNrAbove LineNr
hi! link LineNrBelow LineNr
hi! link CursorLineNr CursorLine
hi! MatchParen cterm=NONE gui=NONE ctermbg=0 ctermfg=15 guibg=#000000 guifg=#ffffff
hi! ModeMsg cterm=bold gui=bold
hi! MoreMsg cterm=bold gui=bold ctermfg=0 ctermbg=NONE guibg=#ffffff guifg=#000000
hi! NonText cterm=NONE gui=NONE ctermfg=0 ctermbg=NONE guibg=#ffffff guifg=#000000
hi! Normal ctermfg=0 ctermbg=NONE guifg=#000000 guibg=#ffffff
...
hi! Question ctermbg=NONE ctermfg=0 cterm=bold gui=bold guifg=#000000 guibg=#ffffff
...
hi! SpellBad cterm=underline gui=undercurl ctermfg=1 ctermbg=NONE guifg=#800000 guibg=#ffffff
...
hi! TabLineFill ctermbg=NONE ctermfg=15 guibg=#ffffff guifg=#000000
hi! TabLineSel ctermbg=8 cterm=NONE gui=NONE ctermfg=15 guifg=#ffffff guibg=#808080
hi! Title ctermbg=NONE ctermfg=0 cterm=bold gui=bold guifg=#000000 guibg=#ffffff
hi! Visual ctermbg=8 ctermfg=15 guifg=#ffffff guibg=#c0c0c0
hi! VisualNOS ctermbg=8 ctermfg=15 guifg=#ffffff guibg=#c0c0c0
hi! WarningMsg ctermbg=NONE ctermfg=1 guibg=#ffffff guifg=#800000
hi! WildMenu ctermbg=7 guibg=#c0c0c0
hi! ColorColumn ctermbg=7 guibg=#c0c0c0

" Preferred groups
hi! Comment ctermfg=8 ctermbg=NONE cterm=NONE gui=NONE guifg=#000000 guibg=#ffffff
hi! Constant ctermfg=8 ctermbg=NONE cterm=NONE gui=NONE guifg=#000000 guibg=#ffffff
hi! Identifier ctermfg=0 ctermbg=NONE cterm=NONE gui=NONE guifg=#000000 guibg=#ffffff
hi! Statement ctermfg=0 ctermbg=NONE cterm=bold gui=bold guifg=#000000 guibg=#ffffff
hi! PreProc ctermfg=0 ctermbg=NONE cterm=NONE gui=NONE guifg=#000000 guibg=#ffffff
hi! Type ctermfg=0 ctermbg=NONE cterm=NONE gui=NONE guifg=#000000 guibg=#ffffff
hi! Special ctermfg=0 ctermbg=NONE cterm=NONE gui=NONE guifg=#000000 guibg=#ffffff
hi! Underlined cterm=underline gui=underline ctermfg=0 ctermbg=NONE guifg=#000000 guibg=#ffffff
hi! Ignore ctermbg=NONE ctermfg=15 guibg=#ffffff guifg=#ffffff
